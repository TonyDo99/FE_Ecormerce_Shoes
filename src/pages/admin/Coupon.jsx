  ...
  return (
    <div className="pt-10 px-8 mx-auto w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="grid grid-cols-3 w-full h-max rounded-lg shadow-all-rounded sm:text-sm cursor-pointer transition duration-500 hover:-translate-y-3">
          ...
          <div className="grid place-content-center w-full border-dashed border-l-2 border-gray_7a82a6 border-opacity-70">
            <img
              src="https://img.icons8.com/external-tal-revivo-shadow-tal-revivo/48/000000/external-reebok-an-english-footwear-and-apparel-company-produces-and-distributes-sportswear-clothing-and-footwear-fashion-shadow-tal-revivo.png"
        ...
        <div className="grid grid-cols-3 w-full h-max rounded-lg transition-colors duration-500 shadow-all-rounded sm:text-sm cursor-pointer">
          <div className="col-span-2 py-6 pl-4">
            <div className="flex flex-col">
              <p>10% off</p>
...
export { CouponSite, InsertCoupon };
